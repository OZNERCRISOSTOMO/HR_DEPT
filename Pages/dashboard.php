    ...
    <div class="row flex-nowrap">
        <div class="main col-lg-12" >
                ...
                <div class="container-fluid d-flex justify-content-center align-items-center mt-4">
                        <h5 style="font-weight:bolder; text-shadow: 2px 2px lightgray"> 
                        <script>                   
                            function updateTime() {
                            const now = new Date();
                    ...
                    <!------------ Modal Buttons ------------ -->
                            ...
                            <div class="container py-4">
                                <div class="row">
                                    <div class="col">
                                <button type="button" class="btn  ps-0 btn-light shadow btn-md p-2 w-100 text-secondary" style="max-width: 200px; max-height: 300px;" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                <span class="fs-5 p-3 text-black">3</span> Employee
                                <span class="badge text-bg-primary rounded-circle"><i class="fa-solid fa-info"></i></span>
                                </button>
                            </div>
                            ...
                            <div class="col">
                                    ...
                                    <span class="badge text-bg-success rounded-circle"><i class="fa-solid fa-info"></i></span>
                                    </button>
                            </div>
                        ...
                        <!------------ Employee Title ------------ -->
                            ...
                            <div class="container">
                                    ...
                                    <div class="container py-3">
                                        <div class="row">
                                            <div class="col-6 ">
                                                <h4 class="p-2"><i class="fa-solid fa-user"></i>&nbsp  EMPLOYEE LIST</h4>
                                            </div>
