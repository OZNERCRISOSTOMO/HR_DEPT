        ...
        <div class=" px-0 bg-white vh-100 position-fixed" style="max-width: 165px">
            <div class="d-flex flex-column align-items-center align-items-sm-start px-3 pt-2 text-white min-vh-100 position-fixed">
                ...
                <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start text-center" id="menu">
                    ...
                    <li class="nav-item mb-5 ps-2">
                    <a href="../admin/prlist.php" class="text-decoration-none nav_link px-0 align-middle text-black"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Payroll</span> </a>
                    </li>
                    <li class="nav-item mb-5 ps-2">
                    <a href="../Payslip JSPDF/index.php" class="text-decoration-none nav_link px-0 align-middle text-black"> <i class='bx bx-bar-chart-alt-2 nav_icon'></i> <span class="nav_name">Payslip</span> </a>
